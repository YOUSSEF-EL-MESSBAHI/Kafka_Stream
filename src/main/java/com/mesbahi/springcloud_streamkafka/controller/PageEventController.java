package com.mesbahi.springcloud_streamkafka.controller;
...
public class PageEventController {
    ...
    public PageEvent sendPageEvent(@PathVariable String topic,@PathVariable String name) {
        PageEvent pageEvent=new PageEvent(name, new Random().nextInt(7000), Math.random()>0.5? "User1" : "User2", new Date());
